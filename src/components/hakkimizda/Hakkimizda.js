...
function Hakkimizda() {
  useDocumentTitle("Elazığ Lavinya Golden Güzellik Merkezi");
  return (
    <div className="col-12">
      ...
      >
        ...
        <div className="card-body col-12" style={{ padding: "3rem" }}>
          ...
          <p class="hizmetyazi">
            Elazığ Lavinya Golden Güzellik Merkezi olarak Lazer Epilasyon, G5
            ...
            müşterimize hizmet verebilmekteyiz.
                ...
                <p className="instaLink" style={{textAlign:"center",color:"gray"}}>Detaylı güncel fotoğraf ve videolar için <a className="instagram"  href="https://www.instagram.com/lavinyagoldendiyarbakir/" target="_blank">Elazığ Lavinya Golden Güzellik Merkezi</a> instagram profilimizi ziyaret edebilirsiniz. </p>
